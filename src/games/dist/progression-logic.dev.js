...
var funcSuccessionWithHole = function funcSuccessionWithHole(
    array,
    randomNumber
) {
    array[randomNumber] = "..";
...
var calculateHiddenNumber = function calculateHiddenNumber(
    array,
    randomNumber
) {
...
var progressionGame = function progressionGame() {
    ...
    for (var i = 0; i < 3; i++) {
        ...
        var rightAns = calculateHiddenNumber(
            arraySucession,
            randomNumberChoiceHole
        );
        var successionWithHole = funcSuccessionWithHole(
            arraySucession,
            randomNumberChoiceHole
        );
